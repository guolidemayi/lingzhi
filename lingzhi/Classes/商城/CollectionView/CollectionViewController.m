...
- (UITableView *)tableView
{
    if (!_tableView)
    {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, kLeftTableViewWidth, DEVICE_WIDTH)];
...
- (UICollectionView *)collectionView
{
    if (!_collectionView)
    {
        _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(kCollectionViewMargin + kLeftTableViewWidth, kCollectionViewMargin, DEVICE_HEIGHT - kLeftTableViewWidth - 2 * kCollectionViewMargin, DEVICE_HEIGHT - 2 * kCollectionViewMargin) collectionViewLayout:self.flowLayout];

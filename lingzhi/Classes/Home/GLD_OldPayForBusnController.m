...
@interface GLD_OldPayForBusnController ()<UITableViewDataSource, UITableViewDelegate,UITextFieldDelegate,GLD_PayForBusiCellDelegate,UIScrollViewDelegate,WXApiManagerDelegate>
...
@implementation GLD_OldPayForBusnController

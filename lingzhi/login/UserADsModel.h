...
@interface UserADsModel : NSObject
@property (copy,nonatomic)NSString *adId;
@property (copy,nonatomic)NSString *title;
@property (copy,nonatomic)NSNumber *startUsingTime;//开始使用时间
@property (copy,nonatomic)NSNumber *endUsingTime;
...
@property (copy,nonatomic)NSString *showImg; //开机图

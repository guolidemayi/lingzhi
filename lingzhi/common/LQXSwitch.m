...
- (void)layoutSubviews
{
    ...
    self.onLabel.frame = CGRectMake(lMargin-7,
                                    r - lHeight / 2.0,
                                    CGRectGetWidth(self.onContentView.bounds) - lMargin - self.ballSize - 2 * margin + 8,
                                    lHeight);
    
    self.offLabel.frame = CGRectMake(self.ballSize + 2 * margin-3,
                                     r - lHeight / 2.0,
                                     CGRectGetWidth(self.onContentView.bounds) - lMargin - self.ballSize - 2 * margin + 8,
                                     lHeight);
}

...
- (UIImageView *)containerView{
    if (_containerView == nil) {
        _containerView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, self.bounds.size.width, self.bounds.size.height)];
...
//    _containerView.image = [UIImage imageNamed:model.imageName];
    #warning
//    [_containerView yy_setImageWithURL:[NSURL URLWithString:model.imageName] placeholder:nil];
}
